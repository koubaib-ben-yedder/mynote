...
router.post("/data/delete/tasks",function(req,res,next){
...
router.post("/data/update/notes",(req,res,next)=>{
  
  const sql="UPDATE notes SET content=? ,date=?, month=? ,years=? ,time=? , day=? ,notebook=? , tag=? WHERE id=?";

  const val=[req.body.notebook,req.body.Date,req.body.Month,req.body.Years,req.body.time,req.body.Day,req.body.notebook,req.body.tag,req.body.id]
...
router.post("/data/update/tasks",(req,res,next)=>{

  
  const sql="UPDATE tasks SET content=? ,date=?, month=? ,years=? ,time=? , day=? ,title=? , color=? WHERE id=?";

  const val=[req.body.content,req.body.Date,req.body.Month,req.body.Years,req.body.time,req.body.Day,req.body.taskbook,req.body.color,req.body.index]
